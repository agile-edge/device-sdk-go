...
func Test_processProvisionWatcherFile(t *testing.T) {
	tests := []struct {
		...
		{"valid load provision watcher from valid uri", "https://raw.githubusercontent.com/agile-edge/device-sdk-go/main/example/cmd/device-simple/res/provisionwatchers/Simple-Provision-Watcher.yml", nil, 1},
		...
		{"invalid load provision watcher from invalid uri", "https://raw.githubusercontent.com/agile-edge/device-sdk-go/main/example/cmd/device-simple/res/provisionwatchers/bogus.yml", nil, 0},
	}
...
func Test_loadProvisionWatchersFromURI(t *testing.T) {
	tests := []struct {
		...
		{"valid load from uri",
			"https://raw.githubusercontent.com/agile-edge/device-sdk-go/main/internal/provision/uri-test-files/provisionwatchers/index.json",
			nil,
			nil,
			2, ""},
		...
		{"invalid load from uri",
			"https://raw.githubusercontent.com/agile-edge/device-sdk-go/main/internal/provision/uri-test-files/provisionwatchers/bogus.json",
			nil,
			nil,
